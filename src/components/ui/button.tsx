  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        "swipe-pass": "rounded-full bg-card text-destructive border-2 border-destructive/20 hover:bg-destructive hover:text-destructive-foreground shadow-lg hover:shadow-xl",
        "swipe-like": "rounded-full bg-card text-success border-2 border-success/20 hover:bg-success hover:text-success-foreground shadow-lg hover:shadow-xl",
        "swipe-save": "rounded-full bg-card text-primary border-2 border-primary/20 hover:bg-primary hover:text-primary-foreground shadow-lg hover:shadow-xl",
      },
      size: {
